  ...
  return (
    <section class="tow" id="contact">
				...
				<form ref={form} onSubmit={sendEmail}>
					...
					<input type="text" placeholder="You Email" name='email' required/>
					<textarea name="message" cols="30" rows="3" placeholder="Your Message" required></textarea>
			...
			<div class="contact-links">
				...
				<a href="https://api.whatsapp.com/send?phone=00249127897927" target='_blank' rel='noreferrer' class="pro"><BsWhatsapp/></a>
			</div>
			</section>
  )
}
